...
## News 🔥
- **[2026-09]** The [v1 trainer](docs/start/diffusion_v1.md) (TransferQueue + ReplayBuffer) is now the default for faster training, and the legacy v0 trainer will be deprecated.
