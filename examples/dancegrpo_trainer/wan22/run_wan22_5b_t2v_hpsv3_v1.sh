#!/usr/bin/env bash
# Wan2.2 LoRA RL with DanceGRPO (V1 trainer: TransferQueue + ReplayBuffer + sync mode).
#
...
MICRO_BATCH_SIZE=4
EXPERIMENT_NAME="wan22_5b_t2v_hpsv3_gpu_v1"
...
python3 -m verl_omni.trainer.main_diffusion_v1 \
    ...
    2>&1 | tee run_wan22_5b_t2v_hpsv3_gpu_v1.log
