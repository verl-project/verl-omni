...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_dir", default="~/dataset/ocr/", help="Path to the raw OCR dataset directory."
    )
    parser.add_argument(
        "--output_dir", default="~/data/ocr", help="Directory to save the preprocessed parquet files."
    )
