#!/usr/bin/env bash
# LTX-2.3 TI2VA (first-frame conditioned) LoRA FlowGRPO (V1 trainer: TransferQueue + ReplayBuffer + sync mode).
#
# This is the V1 sync counterpart of run_ltx2_3_ti2va_lora.sh. It uses
...
python3 -m verl_omni.trainer.main_diffusion_v1 \
    ...
    trainer.experiment_name=ltx2_3_ti2va_lora_v1 \
