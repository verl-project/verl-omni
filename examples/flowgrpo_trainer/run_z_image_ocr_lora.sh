# Z-Image lora RL, vllm_omni rollout
set -x

# Set WORKSPACE to any writable directory; defaults to $HOME
WORKSPACE=${WORKSPACE:-$HOME}

ocr_train_path=$WORKSPACE/data/ocr_zimage/train.parquet
ocr_test_path=$WORKSPACE/data/ocr_zimage/test.parquet

# Z-Image: the full undistilled foundation model.
# Supports true CFG (guidance_scale 3–5) and 28–50 inference steps.
...
python3 -m verl_omni.trainer.diffusion.main_flowgrpo \
    ...
    actor_rollout_ref.rollout.height=1024 \
    actor_rollout_ref.rollout.width=1024 \
    actor_rollout_ref.rollout.max_sequence_length=512 \
    ...
    trainer.experiment_name=z_image_ocr_lora \
