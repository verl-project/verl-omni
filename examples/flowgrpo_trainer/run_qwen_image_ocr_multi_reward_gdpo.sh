# Qwen-Image full-weight RL with multi-reward using GDPO advantage estimator
set -x
...
python3 -m verl_omni.trainer.main_diffusion \
    ...
    reward.aggregation=gdpo \
    trainer.logger='["console", "wandb"]' \
    trainer.project_name=flow_grpo \
    trainer.experiment_name=qwen_image_ocr_multi_reward_gdpo \
