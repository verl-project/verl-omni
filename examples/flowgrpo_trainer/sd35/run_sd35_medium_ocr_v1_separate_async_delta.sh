...
# CKPT_BACKEND is the A/B knob: the default delta_sharded arm ships sparse
# deltas; CKPT_BACKEND=nccl runs the identical full-weight recipe over a full
# broadcast for the bit-exact/sync-time comparison.
...
python3 -m verl_omni.trainer.main_diffusion_v1 \
    ...
    trainer.experiment_name=sd35_medium_ocr_v1_separate_async_${CKPT_BACKEND} \
