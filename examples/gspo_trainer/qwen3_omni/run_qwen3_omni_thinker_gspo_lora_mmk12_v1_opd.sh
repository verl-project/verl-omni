...
TEACHER_N_GPUS_PER_NODE=${TEACHER_N_GPUS_PER_NODE:-8}
...
python3 -m verl_omni.trainer.main_omni \
    ...
    distillation.teacher_models.teacher_model.inference.vllm_omni.output_mode="ar" \
    distillation.teacher_models.teacher_model.inference.vllm_omni.pipeline_name="qwen3_omni_moe" \
    ...
    distillation.teacher_models.teacher_model.inference.max_model_len=16384 \
