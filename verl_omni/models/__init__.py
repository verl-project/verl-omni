...
from .transformers.qwen3_omni_thinker import apply_qwen3_omni_thinker_patches

# register diffusers patches
apply_flash_attention_3_varlen_hub_fix()  # apply FA3 varlen hub fix universally

# Apply the Qwen3-Omni Thinker hf_processor patch on import so the driver (not just
# external_lib-loaded workers) recognizes the processor. Lightweight and idempotent.
