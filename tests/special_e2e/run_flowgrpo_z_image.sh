#!/usr/bin/env bash
# FlowGRPO diffusion e2e smoke test for Z-Image (minimal runtime), vllm_omni rollout.
#
...
python3 -m verl_omni.trainer.diffusion.main_flowgrpo \
    ...
    trainer.experiment_name=flowgrpo-diffusion-z-image-e2e \
...
echo "FlowGRPO Z-Image diffusion e2e test passed (training completed successfully)."
