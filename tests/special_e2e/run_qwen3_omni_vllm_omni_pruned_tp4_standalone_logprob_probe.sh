...
export RUN_ID="${RUN_ID:-pruned_vllm_omni_tp4_standalone_logprob_$(date +%Y%m%d_%H%M%S)}"
...
echo "[info] pruned TP4 standalone vLLM-Omni debug JSONL prefix: ${VERL_OMNI_VLLM_LOGPROB_DEBUG_JSONL}"
