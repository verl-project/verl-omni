...
| Wan2.2 DanceGRPO | [`wan22_dance_grpo/vllm_omni_rollout_adapter.py`](../../verl_omni/pipelines/wan22_dance_grpo/vllm_omni_rollout_adapter.py): list-aware `forward()` and `encode_prompt()`, including empty-negative-prompt handling. |
