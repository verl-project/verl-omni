...
When RM is enabled, set the scoring function in the training script (not hardcoded in the trainer): `reward.custom_reward_function.path=verl_omni/utils/reward_score/genrm_ocr.py`, `name=compute_score_ocr`.
